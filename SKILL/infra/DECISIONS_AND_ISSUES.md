# Infra — segment-level decisions & known issues
...
_(no entries yet — log here when a dev-environment/credentials issue turns
out to affect more than just the one `dev-environment` skill doc)_
